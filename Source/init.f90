...
ALLOCATE(M%HN(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)     ; CALL ChkMemErr('INIT','HN',IZERO)
ALLOCATE(M%HNM1(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)   ; CALL ChkMemErr('INIT','HNM1',IZERO)
