...
OUTPUT_QUANTITY(14)%NAME = 'div(u)'
OUTPUT_QUANTITY(14)%UNITS = '1/s'
OUTPUT_QUANTITY(14)%SHORT_NAME = 'div(u)'

OUTPUT_QUANTITY(15)%NAME = 'div(u*)'
OUTPUT_QUANTITY(15)%UNITS = '1/s'
OUTPUT_QUANTITY(15)%SHORT_NAME = 'div(u*)'

OUTPUT_QUANTITY(16)%NAME = 'Du'
OUTPUT_QUANTITY(16)%UNITS = '1/s'
OUTPUT_QUANTITY(16)%SHORT_NAME = 'Du'

OUTPUT_QUANTITY(17)%NAME = 'Du*'
OUTPUT_QUANTITY(17)%UNITS = '1/s'
OUTPUT_QUANTITY(17)%SHORT_NAME = 'Du*'
...
OUTPUT_QUANTITY(89)%NAME='MASS FRACTION STAR'
OUTPUT_QUANTITY(89)%UNITS='kg/kg'
OUTPUT_QUANTITY(89)%MASS_FRACTION = .TRUE.
OUTPUT_QUANTITY(89)%SHORT_NAME = 'Y*'
OUTPUT_QUANTITY(89)%SPEC_ID_REQUIRED = .TRUE.
...
OUTPUT_QUANTITY(135)%NAME  = 'SUM LUMPED MASS FRACTIONS STAR'
OUTPUT_QUANTITY(135)%UNITS  = ''
OUTPUT_QUANTITY(135)%SHORT_NAME  = 'sum Z*'

OUTPUT_QUANTITY(136)%NAME  = 'SUM PRIMITIVE MASS FRACTIONS STAR'
OUTPUT_QUANTITY(136)%UNITS  = ''
OUTPUT_QUANTITY(136)%SHORT_NAME  = 'sum Y*'
